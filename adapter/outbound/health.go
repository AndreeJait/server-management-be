...
// healthRepository implements outbound.HealthRepository using GORM and Redis.
...
func NewHealthRepository(db *DB, redisConn *RedisConn) outbound.HealthRepository {
