...
type UseCase interface {
	...
	Update(ctx context.Context, projectID uint, appID string, name, frameworkPreset string, envVars entity.StringMap, volumeMounts entity.VolumeMountList, postDeployCommands entity.StringList, basePath, defaultImage, containerPort, publishPort, containerName string) (*entity.AppResponse, error)
