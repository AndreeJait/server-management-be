...
// Cloudflare is a port for interacting with the Cloudflare API.
type Cloudflare interface {
	...
	UpdateTunnelConfig(ctx context.Context, tunnelID string, config *entity.CloudflareTunnelConfig) error
